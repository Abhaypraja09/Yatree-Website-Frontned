    ...
    <section className="relative h-[100svh] min-h-[800px] w-full flex items-center justify-center overflow-hidden bg-[#020617]">
      ...
      <div className="container relative z-10 mx-auto px-6 h-full flex flex-col justify-center">
        <div className="text-center flex flex-col items-center">
          ...
          >
            <Magnetic>
              <a href="tel:+918690091154" className="group relative bg-primary text-white px-12 py-6 rounded-full font-black text-sm uppercase tracking-[0.2em] flex items-center justify-center gap-3 overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_rgba(var(--color-primary),0.4)] hover:shadow-primary/40 active:scale-95">
