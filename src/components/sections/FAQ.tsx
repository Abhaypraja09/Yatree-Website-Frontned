    ...
    <section className="py-32 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mt-16 bg-slate-900 rounded-[2rem] p-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
           ...
           <a href="https://wa.me/918690091154" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-xl font-bold text-sm uppercase tracking-widest hover:bg-green-600 transition-colors shrink-0">
