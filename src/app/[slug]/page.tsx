      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden bg-midnight">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center mt-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="tel:+919257109728" className="h-14 px-8 rounded-full border border-white/20 bg-white/5 backdrop-blur-md text-white font-bold flex items-center gap-2 transition-all hover:bg-white/10 hover:border-white/40 active:scale-95">
