                ...
                <div key={i} className="bg-white rounded-lg shadow-md border border-slate-200 overflow-hidden flex flex-col md:flex-row">
                   ...
                   <div className="md:w-2/3 p-6 md:p-8 flex flex-col justify-between">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                        <a href="tel:+918690091154" className="flex-1 bg-[#1a365d] hover:bg-navy-800 text-white font-bold py-4 rounded text-center transition-colors flex justify-center items-center gap-2 uppercase tracking-wide">
