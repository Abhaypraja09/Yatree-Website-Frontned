        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
           <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
             ...
             <div className="flex flex-wrap justify-center gap-4">
                <a href="tel:+919257109728" className="bg-orange-500 text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest text-sm flex items-center gap-3 hover:bg-orange-600 transition-colors shadow-lg">
              ...
              <div className="lg:col-span-4">
                 <div className="sticky top-24 space-y-8">
                    ...
                    <div className="bg-slate-900 p-8 rounded-[2rem] text-white shadow-2xl">
                       ...
                       <a href="tel:+919257109728" className="w-full bg-orange-500 py-4 rounded-xl text-center font-bold uppercase tracking-widest text-xs mt-8 block hover:bg-orange-600 transition-colors">
                          Instant Booking
                       </a>
                    </div>
